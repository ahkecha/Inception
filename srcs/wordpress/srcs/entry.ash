...
sed -i -e "s/database_name_here/$DB_NAME/g" -e "s/username_here/$DB_USER/g" -e "s/password_here/$DB_PASSWD/g" -e "s/localhost/172.23.0.2/g" /var/www/html/wp-config.php
...
then
	...
	echo "listen = 127.0.0.1:9000" >> /etc/php7/php-fpm.d/www.conf
	echo "OK"
fi
